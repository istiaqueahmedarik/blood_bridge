...
import { AcceptRequest, AcceptRequestHospital, RejectRequest, RejectRequestHospital } from "@/app/actions/bloodbank"
import { X } from "lucide-react"
import { RejectModal } from "./RejectModal"
import { Badge } from "./ui/badge"


export default function HospitalRequestsPage({ data, data1 }: any) {
    console.log(data1);
    ...
    const [state, formAction, pending] = useActionState(AcceptRequestHospital, null)
    ...
    const handleRejectSubmit = async (explanation: string) => {
        ...
        await RejectRequestHospital(selectedRequestId, explanation)
    ...
    return (
        <div className="container mx-auto p-4 space-y-8">
            <header className="flex justify-between items-center">
                <h1 className="text-3xl font-bold mb-4">Blood Test Requests</h1>
