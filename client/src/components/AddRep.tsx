...
export default function AddRep({ data }: any) {
    ...
    const [state, formAction, isPending] = useActionState(AddReport, null)
                            ...
                            {(userId || fullName) && (
                                ...
                                >
                                    ...
                                    <div className="flex space-x-2">
                                        <Checkbox id="inventory-checkbox" name="inventory" required />
                                        <Label htmlFor="inventory-checkbox" className="text-sm font-medium">
