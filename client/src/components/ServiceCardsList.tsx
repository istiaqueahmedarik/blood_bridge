...
import ServiceVer from "@/components/ServiceVer"
import Image from "next/image"



export default function ServiceCardsList({ data }: any) {
    const [expandedId, setExpandedId] = useState<number | null>(null)
    const [searchTerm, setSearchTerm] = useState("")

    const filteredCards = data.filter(
        (card: any) =>
            card.Service_name.toLowerCase().includes(searchTerm.toLowerCase()) ||
